...
.p-rating-option {
    ...
    border-radius: 50%;
    transition: background ${dt2("rating.transition.duration")}, color ${dt2("rating.transition.duration")}, border-color ${dt2("rating.transition.duration")}, outline-color ${dt2("rating.transition.duration")}, box-shadow ${dt2("rating.transition.duration")};
}

.p-rating-option.p-focus-visible {
    box-shadow: ${dt2("rating.focus.ring.shadow")};
    outline: ${dt2("rating.focus.ring.width")} ${dt2("rating.focus.ring.style")} ${dt2("rating.focus.ring.color")};
    outline-offset: ${dt2("rating.focus.ring.offset")};
}

.p-rating-icon {
    color: ${dt2("rating.icon.color")};
    transition: background ${dt2("rating.transition.duration")}, color ${dt2("rating.transition.duration")}, border-color ${dt2("rating.transition.duration")}, outline-color ${dt2("rating.transition.duration")}, box-shadow ${dt2("rating.transition.duration")};
    font-size: ${dt2("rating.icon.size")};
    width: ${dt2("rating.icon.size")};
    height: ${dt2("rating.icon.size")};
}

.p-rating:not(.p-disabled):not(.p-readonly) .p-rating-option:hover .p-rating-icon {
    color: ${dt2("rating.icon.hover.color")};
}

.p-rating-option-active .p-rating-icon {
    color: ${dt2("rating.icon.active.color")};
}

/* For PrimeNG */
p-rating.ng-invalid.ng-dirty > .p-rating > .p-rating-icon {
    stroke: ${dt2("rating.invalid.icon.color")};
}`;
var classes = {
  root: ({
    props
